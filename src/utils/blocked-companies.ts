/**
 * Blocked Company Names List
 * Companies that are not allowed to be registered in the system
 * This includes reserved names,知名品牌, and restricted enterprise names
 */

export const BLOCKED_COMPANY_NAMES = [
    // Big Vietnamese Tech Companies
...
/**
 * Check if a company name is blocked
 */
export function isCompanyNameBlocked(companyName: string): boolean {
...
/**
 * Get list of blocked names for display purposes
 */
export function getBlockedCompanyNamesList(): readonly string[] {
    return BLOCKED_COMPANY_NAMES
}
