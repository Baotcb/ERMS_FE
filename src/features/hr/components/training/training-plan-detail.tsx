        ...
        <div className="bg-gradient-to-r from-[#0F4C75] to-[#3282B8] px-6 py-8 text-white relative overflow-hidden">
          ...
          <DialogHeader>
            <div className="flex justify-between items-start relative z-10">
              ...
              <Badge
                className={`${STATUS_COLORS[plan.status]} border font-bold px-3 py-1 shadow-sm`}
              >
                {getStatusLabel(plan)}
              </Badge>
            </div>
            ...
            {plan.reviewNote ? (
              ...
              <>
                ...
                <div className="text-sm text-gray-600 leading-relaxed bg-gray-50 p-4 rounded-2xl border border-gray-100 min-h-[80px]">
                  {plan.description ||
                    "Không có mô tả chi tiết cho kế hoạch này."}
                </div>
              </>
            )}
          </div>
                    ...
                    <tbody className="divide-y divide-gray-100">
                      {detailData.trainingRequests.map((req) => (
                        ...
                        >
                          ...
                          <td
                            className="px-4 py-3 text-gray-600 line-clamp-1 truncate max-w-[200px]"
                            title={req.subject}
                          >
                            {req.subject}
                          </td>
