            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden animate-in fade-in slide-in-from-bottom-2 duration-500">
                <Table>
                    <TableHeader className="bg-gray-50">
                        <TableRow>
                            <TableHead className="font-bold text-[#0F4C75] w-1/3">Khóa học</TableHead>
                            ...
                            courses.map((course) => (
                                <TableRow key={course.id} className="hover:bg-gray-50/50 transition-colors">
                                    <TableCell className="font-medium text-gray-900">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-xs text-gray-500 mt-0.5">{course.courseCode}</div>
                                            </div>
                                        </div>
                                    </TableCell>
                                    ...
                                    <TableCell className="text-right">
                                        <Button variant="ghost" className="h-8 px-2 text-[#0F4C75] hover:bg-blue-50" asChild>
                                            <Link href={`/enterprise/hr/training/courses/${course.id}`}>
