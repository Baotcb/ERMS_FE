...
import { HRNavbarSettingsDropdown } from './hr-navbar-settings-dropdown'
...
const NavAction = memo(function NavAction({ href, icon: Icon, label }: NavActionProps) {
    return (
        <Link
            href={href}
            aria-label={label}
    ...
    return (
        <header className="sticky top-0 z-30 flex h-14 items-center justify-between border-b border-gray-200 bg-white px-4">
            ...
            <div className="flex items-center gap-3">
                ...
                <Link href="/enterprise/hr/dashboard" className="flex items-center gap-2">
