...
const STEPS = [
  {
    ...
    icon: Target,
    description: "Vị trí, số lượng & hạn nộp",
  },
  {
    id: 2,
...
export function JobPostingWizardDialog({
  ...
  const doGenerate = async () => {
    ...
    try {
      const result = await generateJD({ planDetailId, userPrompt: currentReq });
      ...
      toast({
        ...
        description:
          err instanceof Error
            ? err.message
            : "Tạo JD thất bại, vui lòng thử lại.",
        variant: "destructive",
      });
    }
  };
  ...
  const handleGenerateJD = async () => {
    ...
    if (!planDetailId) {
      toast({
        title: "Lỗi",
        description: "Vui lòng chọn Kế hoạch tuyển dụng trước.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      const payload: any = {
        ...
        applicationDeadline: data.applicationDeadline
          ...
          : new Date().toISOString(), // Fallback to now if empty, although validation should catch it
          ...
          <div className="bg-gradient-to-br from-indigo-600 via-blue-600 to-sky-600 p-8 text-white relative overflow-hidden">
            ...
            <DialogHeader className="relative z-10 flex flex-row items-center justify-between">
              ...
              <div className="bg-white/10 backdrop-blur-md px-4 py-2 rounded-full border border-white/20 text-sm font-semibold">
                Bước <span className="text-white text-lg">{step}</span> /{" "}
                {STEPS.length}
              </div>
            </DialogHeader>
            ...
            <div className="flex items-center justify-between mt-10 relative z-10 px-6">
              {STEPS.map((s, idx) => {
                ...
                return (
                  <div
                    key={s.id}
                    className="flex flex-col items-center gap-3 relative z-10 w-full group cursor-default"
                  >
                    <div
                      className={cn(
                        "w-12 h-12 rounded-full flex items-center justify-center border-2 transition-all duration-500 shadow-lg",
                        isCompleted
                          ? "bg-white text-blue-600 border-white scale-100"
                          : isCurrent
                            ? "bg-indigo-500 text-white border-white ring-4 ring-white/20 scale-110"
                                  ...
                                  <FormItem className="col-span-2">
                                    ...
                                    <FormControl>
                                      <Input
                                        ...
                                        className="text-lg font-medium shadow-sm transition-all focus:ring-2 focus:ring-indigo-100 focus:border-indigo-400"
                                        {...field}
                                      />
                                    </FormControl>
                                    <FormMessage />
                                  ...
                                  <FormItem>
                                    ...
                                    <FormControl>
                                      <Input
                                        type="number"
                                        min={1}
                                        className="transition-all focus:ring-2 focus:ring-indigo-100"
                                        {...field}
                                        onChange={(e) =>
                                          field.onChange(
                                  ...
                                  <FormItem>
                                    ...
                                    <FormControl>
                                      <div className="relative group">
                                        ...
                                        <Input
                                          className="pl-9 transition-all focus:ring-2 focus:ring-indigo-100"
                        ...
                        <div className="space-y-6">
                          <div className="flex flex-col items-center justify-center p-8 bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl border border-green-100 shadow-sm relative overflow-hidden">
                            ...
                            <p className="text-green-700 text-sm text-center max-w-sm mt-2 opacity-90">
                              Công khai mức lương giúp tăng{" "}
                              <span className="font-bold">40%</span> lượng ứng
                              viên nộp hồ sơ.
                            </p>
                          </div>
                              ...
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem>
                                    ...
                                    <FormControl>
                                      <CurrencyInput
                                        className="transition-all focus:ring-2 focus:ring-green-100 focus:border-green-400"
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-xl border border-slate-200 p-4 shadow-sm bg-slate-50/50 hover:bg-slate-50 transition-colors cursor-pointer">
                                  ...
                                  <div
                                    className="space-y-1 leading-none select-none"
                                  ...
                                  >
                                    ...
                                    <FormDescription className="text-slate-500">
                                      Nếu bỏ chọn, tin tuyển dụng sẽ hiển thị
                                      &quot;Thỏa thuận&quot;.
                                    </FormDescription>
                                  </div>
                                </FormItem>
                            ...
                            <div className="grid grid-cols-2 gap-y-6 gap-x-8 text-sm">
                              ...
                              <div>
                                ...
                                <span className="font-mono text-slate-700 bg-slate-100 px-2 py-0.5 rounded text-xs">
                                  {form.getValues("planDetailId") || "N/A"}
                                </span>
                              </div>
                              <div>
                                <span className="text-slate-500 block mb-1">
                                ...
                                <span className="font-medium text-slate-800">
                                  {form.getValues("quantity")} nhân sự
                                </span>
                              </div>
                              <div>
                                <span className="text-slate-500 block mb-1">
                              ...
                              <div>
                                ...
                                <span className="font-medium text-slate-800">
                                  {form.getValues("applicationDeadline")}
                                </span>
                              </div>
                              <div className="col-span-2 p-4 bg-green-50 rounded-lg border border-green-100">
                                <span className="text-green-700 block mb-1 text-xs uppercase font-bold tracking-wider">
                                  Mức lương
                                </span>
                          ...
                          <div className="flex items-start gap-4 p-4 bg-blue-50/50 border border-blue-100 text-blue-800 rounded-xl text-sm">
                            ...
                            <div>
                              ...
                              <p className="text-blue-700/80 mt-1">
                                Tin tuyển dụng sẽ được hiển thị ngay lập tức
                                trên trang tuyển dụng của doanh nghiệp. Bạn có
                                thể chỉnh sửa hoặc đóng tin bất cứ lúc nào trong
                                trang quản lý.
                              </p>
                            </div>
                          </div>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Nội dung mô tả, yêu cầu và phúc lợi hiện tại sẽ bị thay thế bằng
              nội dung do AI tạo ra. Bạn có chắc chắn muốn tiếp tục?
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
