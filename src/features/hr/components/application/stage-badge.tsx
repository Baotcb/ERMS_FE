...
const STAGE_CONFIG: Record<ApplicationStage, { label: string; className: string }> = {
    ...
    Shortlisted: { label: 'Đã sơ tuyển', className: 'bg-green-100 text-green-700 hover:bg-green-200' },
    ...
    OfferProcessing: { label: 'Đang xử lý offer', className: 'bg-amber-100 text-amber-700 hover:bg-amber-200' },
    Offered: { label: 'Đã đề nghị', className: 'bg-orange-100 text-orange-700 hover:bg-orange-200' },
