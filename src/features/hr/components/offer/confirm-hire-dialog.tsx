            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex items-center gap-4 p-4 rounded-xl bg-slate-50 border border-slate-100">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-slate-900 text-base font-bold line-clamp-2">
                    {candidateName}
                  </p>
              ...
              <div className="flex flex-col gap-2">
                ...
                />
                <p className="text-xs text-slate-500 leading-relaxed break-words pr-2">
                  Email này sẽ được dùng làm tài khoản đăng nhập hệ thống. Mật
                  khẩu tạm sẽ được gửi qua email cá nhân ứng viên.
                </p>
              </div>
            </div>
          ) : (
            ...
            <div className="flex flex-col items-center text-center gap-4 py-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 mt-1">
                  Tài khoản nhân viên đã được tạo và thông tin đăng nhập đã gửi
                  qua email.
                </p>
              </div>
