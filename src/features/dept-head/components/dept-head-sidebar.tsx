...
const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    label: "Nhân sự",
    href: "/enterprise/dept-head/employees",
  },
  {
    ...
    children: [
      {
        ...
        href: "/enterprise/dept-head/recruitment",
      },
  ...
  },
  {
    ...
    children: [
      { label: "Yêu cầu của tôi", href: "/enterprise/dept-head/training" },
      {
        ...
        href: "/enterprise/dept-head/training/plans",
      },
      {
        label: "Khóa học khả dụng",
        href: "/enterprise/dept-head/training/courses",
      },
      {
        label: "Phân công đào tạo",
        href: "/enterprise/dept-head/training/assign",
      },
    ],
  },
  {
      ...
      >
        <div className="ml-8 mt-1 space-y-1">
          {item.children?.map((child) => {
            ...
            const isChildActive =
              isExactMatch || (isStartsWithMatch && !hasSiblingBetterMatch);
