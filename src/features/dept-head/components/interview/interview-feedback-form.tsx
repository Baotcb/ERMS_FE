...
import { Star, ThumbsUp, HelpCircle, ThumbsDown } from 'lucide-react'
...
export function InterviewFeedbackForm({
    ...
    }, [applicationId, interviewId, rating, feedback, recommendation, trigger, toast, onSuccess])
    ...
    return (
        <div className="max-w-[800px] mx-auto py-8 px-4 space-y-6">
            ...
            <div className="flex justify-end gap-3">
                {onCancel && (
                    <Button variant="outline" onClick={onCancel} disabled={isMutating}>Hủy</Button>
                )}
                <Button
