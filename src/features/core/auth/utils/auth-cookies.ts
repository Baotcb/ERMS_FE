...
export function setAuthCookies({
  ...
  document.cookie = `auth_token=${token}; path=/; max-age=${maxAge}${secureFlag}; SameSite=Lax`;
  document.cookie = `user_role=${role}; path=/; max-age=${maxAge}${secureFlag}; SameSite=Lax`;
  document.cookie = `user_name=${encodeURIComponent(displayName)}; path=/; max-age=${maxAge}${secureFlag}; SameSite=Lax`;
}
